  ...
  <body>
      <header>
            ...
            <div class="collapse navbar-collapse" id="navbarsExample03">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="../Projet_Git_TM/index.php">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../Projet_Git_TM/news.php">News</a>
                </li>
                <li class="nav-item">
    ...
    <div class="dropdown mt-3">
        ...
        <li><a class="dropdown-item" href="#">Avion + hôtel **** + Excursions + Services extra offerts*</a></li>
            ...
            <div class="carousel-inner">
                ...
                <img src="../Projet_Git_TM/img/Paysage4.jpg" class="d-block w-100" alt="paysage1">
                </div>
                <div class="carousel-item">
                <img src="../Projet_Git_TM/img/Paysage5.jpg" class="d-block w-100" alt="paysage2">
                </div>
                <div class="carousel-item">
                <img src="../Projet_Git_TM/img/Paysage6.jpg" class="d-block w-100" alt="paysage3">
                </div>
            </div>
